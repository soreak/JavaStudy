...
public class ServerTest {
        ...
        public static void main(String[] args) throws Exception {
            ...
            ServerSocket serverSocket = new ServerSocket(ConstantTest.SERVER_PORT);
        ...
        public void run() {
            try{
                ...
                BufferedOutputStream bos =
                        new BufferedOutputStream(new FileOutputStream(ConstantTest.SERVER_DIR+ UUID.randomUUID().toString()+".jpg"));
